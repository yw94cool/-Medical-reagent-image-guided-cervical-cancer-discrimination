...
def crack_captcha(captcha_image, numberOfImage, modelfile, IMAGE_WIDTH, IMAGE_HEIGHT):
    ...
    with tf.Session() as sess:
        ...
        #     print("未知数量：", numberOfImage, "预测为阳性：", yisi2yang, "预测为阴性；", yisi2yin, "预测为疑似：", yisi)
...
if __name__ == '__main__':
        ...
        #             "D:\\AI4Medical\\project0315\\data180712\\yang65.JPG",
        #              "D:\\AI4Medical\\project0315\\data180712\\yisi5.JPG",
        #            "D:\\AI4Medical\\project0315\\data180418\\20180410--42-2.JPG"]
        dirList = []
        infile = open(sys.argv[1])
        for each_line in infile:
            dirList.append(each_line.split("\n")[0][1:-1])
        print(dirList)
        root_path = './'
